...
var appid = 1400061792;
var appkey = "3f54436ecd8fdbda475019b0721b0e4f";
var phoneNumbers = ["17600108288"];
var templId = 7839;
...
$(function () {
	...
	*/
	...
	$("#noButton").hover(function () {
		...
		$("#okButton").text("NO").addClass("noButton").removeClass("okButton")
	})

	$("#okButton").hover(function () {
		$("#noButton").text("NO").addClass("noButton").removeClass("okButton")
		$("#okButton").text("OK").addClass("okButton").removeClass("noButton")
	})
	...
	function calculateSignature(appkey, random, time, phoneNumber) {
		console.log('aaa: ', CryptoJS.SHA256(
